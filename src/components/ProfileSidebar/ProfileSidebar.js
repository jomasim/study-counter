        ...
        <div className="pl-lg-5">
          ...
          <div className="bg-white shadow-9 rounded-4">
            <div className="px-5 py-11 text-center border-bottom border-mercury">
              <Link href="/#">
                <a className="mb-4">
                  <img className="circle-54" src={imgF1} alt="" />
                </a>
              </Link>
              <h4 className="mb-0">
                <Link href="/#">
              ...
              <p className="mb-8">
                <Link href="/#">
                  <a className="text-gray font-size-4">Academic Research</a>
                </Link>
              </p>
            ...
            <div className="px-9 pt-lg-5 pt-9 pt-xl-9 pb-5">
              ...
              <div className="mb-7">
                ...
                <h5 className="font-size-4 font-weight-semibold mb-0">
                  <a
                    ...
                    href="mailto:support@studycounter.com"
                  >
                    support@studycounter.com
                  </a>
                </h5>
              </div>
              {/* <!-- Single List --> */}
              ...
              <div className="mb-7">
                ...
                <h5 className="font-size-4 font-weight-semibold mb-0">
                  <a className="text-black-2 text-break" href="tel:+1 234-253-4050">
                      +1 234-253-4050
                  </a>
                </h5>
              </div>
              ...
              {/* <!-- Single List --> */}
              <div className="mb-7">
                <p className="font-size-4 mb-0">Website Link</p>
                <h5 className="font-size-4 font-weight-semibold mb-0">
                  <Link href="/#">
                    <a className="text-break">www.studycounter.com</a>
                  </Link>
                </h5>
              </div>
              {/* <!-- Single List --> */}
