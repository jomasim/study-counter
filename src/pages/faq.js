...
const Redirect = redirect('https://facebook.com')
              ...
              >
                <div className="">
                  ...
                  <p className="font-size-4 mb-2">
                    ...
                    <div>
                      <a  href="https://www.facebook.com/myStudycounter" className="font-size-4 font-weight-bold text-green text-lowercase">
                        Chat with us
                      </a>
                    </div>                  
                </div>
                  ...
                  >
                    <div className="border-bottom overflow-hidden">
                      ...
                      <Collapse in={openItem === 1}>
                        <div className="pr-7">
                          ...
                          Study Counter offers flexible ways to create, track and manage your order.
                            Out of experience we highly recommend chatting with our support team or
                            any tutor to discus the details of your assignment before creating an orders.
                            That ensures your are familair with the study counter working process.
                          </div>
                        </div>
                      </Collapse>
                    </div>                   
                    <div className="border-bottom overflow-hidden">
                      ...
                      <Collapse in={openItem === 4}>
                        <div className="pr-7">
                          <div className="mt-n3 font-size-4 text-gray font-weight-normal pb-7 pr-7 pt-6">
                            Currently we reccomend creating your order through our social media channels,
                            especially facebook. That way you will have the advantage of realtime chat
                            with our tutors or support to help you easily create your order.
                          </div>
                        </div>
                      </Collapse>
                    </div>                    
                    <div className="border-bottom overflow-hidden">
                      ...
                      <Collapse in={openItem === 9}>
                        <div className="cpr-7">
                          <div className="mt-n3 font-size-4 text-gray font-weight-normal pb-7 pr-7 pt-6">
                            Each tutor session or assignment has its unique requirements that may
                            necesitate customized pricing but the evarage rate is $15-20/Hr.
                          </div>
                        </div>
                      </Collapse>
                    </div>
